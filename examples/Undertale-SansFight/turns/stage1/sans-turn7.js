...
export default class SansTurn7 extends UTMX.BattleTurn {
    ...
    onTurnStart() {
        ...
        this.mainPlatform = this.blueSoulController.createPlatform(20);
    ...
    onTurnUpdate(delta) {
        ...
        if (this.state == 0) {
            if (this.mainPlatform.position.x > 320+175) {
                this.state = 1;
            }
