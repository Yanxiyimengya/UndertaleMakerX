...
{
    private static readonly Lazy<UtmxDialogueQueueManager> _instance =
        new Lazy<UtmxDialogueQueueManager>(() => new UtmxDialogueQueueManager());
    private UtmxDialogueQueueManager() { }
    public static UtmxDialogueQueueManager Instance => _instance.Value;
    private Queue<UtmxDialogueData> _dialogueQueue = new Queue<UtmxDialogueData>();
    private Dictionary<int, Queue<UtmxDialogueData>> _enemysDialogueQueues = new Dictionary<int, Queue<UtmxDialogueData>>();
    ...
    public Dictionary<int, UtmxDialogueData> GetBattleEnemyDialogues()
    {
